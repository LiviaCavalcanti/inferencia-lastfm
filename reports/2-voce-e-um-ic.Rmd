...
reamostragens %>%
  ...
  geom_histogram(binwidth = .002,
                 ...
                 fill = "white")
```
Fazendo o bootstrap manualmente, percebe-se que a maior parte dos dados se encontra entre 0.235 e 0.255. Indicando que a maioria das pessoas escutou, no período da coleta dos dados, ou seja, nessa amostra, para o total de artistas escutados, 25% são artistas novos.
*Usando biblioteca*
```{r}
iterations=10000
...
booted=boot(data = samples_lastfm, statistic=bootstrap_step_summarise,R = iterations)
